...
<div class="py-6 h-screen">
    <div class="flex border border-grey rounded shadow-lg h-full">
        ...
        <div class="w-1/3 border flex flex-col">
            <!-- Header -->
            <div class="py-2 px-3 bg-blue-400 flex flex-row justify-between items-center">
                <div>
            ...
            <div class="bg-grey-lighter flex-1 overflow-auto">
                <div class="px-3 flex items-center bg-indigo-400 cursor-pointer">
                    <div>
                ...
                <div class="px-3 flex items-center bg-black-400 hover:bg-indigo-400 cursor-pointer">
                    <div>
        ...
        <div class="w-2/3 border flex flex-col">
            <!-- Header -->
            <div class="py-2 px-3 bg-pink-600 flex flex-row justify-between items-center">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="text-grey-darkest">New Movie! Expendables 4</p>
                        <p class="text-grey-darker text-xs mt-1">Active Now</p>
                    </div>
                </div>
                <div class="flex">
                    <div>
            ...
            <div class="flex-1 overflow-auto" style="background-color: #bd7d3d" id="messageBox">
                <div class="py-2 px-3">
                    <div class="flex justify-center mb-2">
                        ...
                        <p class="text-sm uppercase">January 11, 2024</p>
                        </div>
                    </div>

                    <div class="flex justify-center mb-4">
                        <div class="rounded py-2 px-4" style="background-color: #050505">
                        <p class="text-xs">Messages to this chat and calls are now secured with end-to-end encryption. Tap for more info.</p>
                        </div>
                    </div>

                    <div class="flex mb-2">
                        <div class="rounded py-2 px-3" style="background-color: #332e2e">
            ...
            <!-- Input -->
            <div class="bg-pink-600 px-4 py-4 flex items-center">
                <div>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
